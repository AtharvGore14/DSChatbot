    ...
    try {
        ...
        if (cmd == "trie" && argc >= 3) {
            ...
            vector<string> symbols = {
                "ASIANPAINT.NS", "AXISBANK.NS", "BAJFINANCE.NS", "BHARTIARTL.NS",
                "COALINDIA.NS", "DRREDDY.NS", "HCLTECH.NS", "HDFCBANK.NS",
                "HINDUNILVR.NS", "ICICIBANK.NS", "INFY.NS", "ITC.NS",
                "KOTAKBANK.NS", "LT.NS", "MARUTI.NS", "NESTLEIND.NS",
                "NTPC.NS", "ONGC.NS", "POWERGRID.NS", "RELIANCE.NS",
                "SBIN.NS", "SUNPHARMA.NS", "TATAMOTORS.NS", "TCS.NS",
